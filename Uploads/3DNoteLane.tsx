// src/components/Down3DNoteLane.tsx (Refactored main component)
...
import { getColorForLane } from '@/lib/utils/laneUtils'; // New util
...
import { SoundpadButtons } from '@/components/SoundpadButtons';
import { JudgementLines } from '@/components/JudgementLines';
import { HoldNotes } from '@/components/HoldNotes';
...
export function Down3DNoteLane({
  notes,
  currentTime,
  health = 100, // Assuming MAX_HEALTH is 100, adjust as needed
  combo = 0,
  onPadHit,
  onDeckHoldStart,
  onDeckHoldEnd,
