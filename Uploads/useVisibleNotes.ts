          ...
          try {
            ...
            if (n.type === 'SPIN_LEFT' || n.type === 'SPIN_RIGHT') {
              ...
              if (failures.hasAnyFailure) {
                ...
                visibilityEnd = holdEndTime + HOLD_ANIMATION_DURATION;
              }
                ...
                if (!holdNotesByLane[n.lane]) {
                  ...
                  if (stored) {
                    const storedIsExpired =
                      currentTime >
                      (stored.failureTime
                        ? stored.failureTime + HOLD_ANIMATION_DURATION
                        : stored.time + LEAD_TIME + 2000);
            ...
            GameErrors.log(
              `Down3DNoteLane: Visibility filter error for note ${i}: ${
