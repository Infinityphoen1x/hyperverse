...
import { VANISHING_POINT_X, VANISHING_POINT_Y, HEXAGON_RADII, RAY_ANGLES, TUNNEL_MAX_DISTANCE, TUNNEL_CONTAINER_WIDTH, TUNNEL_CONTAINER_HEIGHT, MAX_HEALTH } from '@/lib/utils/gameConstants';
