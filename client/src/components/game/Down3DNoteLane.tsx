        ...
        >
          {visibleNotes
            ...
            .map(note => {
              ...
              // Far end: grows from vanishing point (1) toward judgement line (187) in phase 1, then continues outward in phase 2
              let farDistance;
              if (isInPhase2) {
                const growProgress = holdProgress - 1.0; // 0 to 1.0 during phase 2
